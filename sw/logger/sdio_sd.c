/**
  ******************************************************************************
  * @file    sdio_sdcard.c
  * @author  MCD Application Team, modified by TU Delft
  * @brief   This SDIO SD card library is based on the stm324xg_eval_sdio_sd.c
  *          library provided by ST. It has serveral aditions to simplifiy the
  *          usage. For example, low-level initialization is added to this lib.
  *          
  *            
  *  @verbatim
  *
...
SD_Error SD_Init(void)
{
  ...
  /* Reset SDIO interface to default settings. */
  SDIO_DeInit();
...
void NVIC_Configuration_SDIO(void) {
